              ...
              displayedPost?.map((post) => {
                return (
                  <div key={post?._id} className='relative group cursor-pointer'>
                   ...
                   <div className="absolute inset-0 flex items-center justify-center bg-[rgba(26,25,25,0.6)] opacity-0 group-hover:opacity-100 transition-opacity duration-300">
